...
class TouristSpotRecyclerAdapter(
    val context: Context,
    private val items: MutableList<TouristSpotItem>,
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        Glide.with(context).load(if (item.img_path != "") item.img_path else R.drawable.malddong)
            .into(holder.ivImg)
